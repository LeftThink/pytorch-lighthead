...
if __name__ == '__main__':
    ...
    if args.resume:
        load_name = os.path.join(output_dir,
                        '{}_{}_{}_{}.pth'.format(prefix, args.checksession, args.checkepoch, args.checkpoint))
        ...
        if os.path.exists(load_name):
            ...
            print("checkpoint %s not exist,skip" % (load_name))
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(start_step, iters_per_epoch):
            ...
            if step % args.disp_interval == 0:
                ...
                save_name = os.path.join(output_dir, '{}_{}_{}_{}.pth'.format(prefix, args.session, epoch, step))
                save_checkpoint({
